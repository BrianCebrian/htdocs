  ...
  <div class="main">
      <form action="./sender.php" method="get" target="_blank">
        <fieldset>
          ...
          <br />
          <br />
          <input type="text" cols="50" name="XXXXX" placeholder="asd" autofocus required>
          <input type="email" cols="50" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  placeholder="asd" autocomplete="off"  required>
